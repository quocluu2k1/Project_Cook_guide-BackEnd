...
public class Food {
    ...
    public Food(String name, String description, int level, Long nSavoring, Long nHearts, Long nClaps, String foodImage1, String foodImage2, String foodImage3, Date date, int totalTime) {
        this.foodId = foodId;
        this.name = name;
