...
public class ImageStorageService implements IStorageService{
    ...
    private final Path storageFolder = Paths.get("src/main/resources/static/images/avatar");
...
//                throw new RuntimeException("File must be <= 10MB");
    ...
    public void deleteFile(String urlFile){
        if(urlFile!=null && urlFile!="/images/avatar/avatar-default.png"){
            String fileName = urlFile.replaceAll("/images/avatar/","");
