...
public class FoodDto {
    ...
    public FoodDto(Long foodId, String name, String description, int level, Long nSavoring, Long nHearts, Long nClaps, String foodImage1, String foodImage2, String foodImage3, Date date, int totalTime) {
        this.foodId = foodId;
        this.name = name;
    ...
    public FoodDto(Food food) {
        ...
        this.totalTime = food.getTotalTime();
    }
