...
@Service
public class ImageCommentStorageService{
    Logger logger = LoggerFactory.getLogger(Logger.class);

    private final Path storageFolder = Paths.get("src/main/resources/static/images/comment");

    public ImageCommentStorageService(){
        try {
...
//                throw new RuntimeException("File must be <= 10MB");
    ...
    public void deleteFile(String urlFile){
        if(urlFile!=null){
            String fileName = urlFile.replaceAll("/images/comment/","");
